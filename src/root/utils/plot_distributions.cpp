...
void plot_distributions()
{
  ...
  // Crea una canvas divisa in 4 pad
  ...
  // Esegui il fit sull'istogramma dell'impulso
  ...
  // Definisci la funzione costante per il fit
  ...
  // Esegui il fit sull'istogramma dell'angolo polare
  ...
  c->cd(4); // Seleziona il quarto pad
  ...
  // Esegui il fit sull'istogramma dell'angolo azimutale
