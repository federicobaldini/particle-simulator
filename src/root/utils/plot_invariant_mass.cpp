...
void plot_invariant_mass()
{
  ...
  // 1) Sottraggo l'istogramma delle masse invarianti con stessa carica da quello con carica opposta
  ...
  // 2) Sottraggo l'istogramma delle masse invarianti Pion-Kaon con stessa carica da quello con carica opposta
  ...
  // Eseguo il fit gaussiano sull'istogramma
